...
async def run_simulator_async(symbol="AAPL", interval="1m", period="1h", initial_cash=50000, max_iterations=100):
...
def parse_args():
    ...
    parser.add_argument("--period", default="1h", help="Data period (e.g., 1h, 1d)")
